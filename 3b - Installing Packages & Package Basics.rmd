...
library(dplyr) 
# require(dplyr) returns TRUE if the package is already installed; so you can use it to check if a package exists
# Also it does not raise an error immediately if the package as not installed
require(dplyr) 
