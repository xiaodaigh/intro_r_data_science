...
- The data.table package is a an increasing popular package
- It is a a **much** faster replacement for data.frame
- It's compatitable with most code that operate on data.frames
- It's syntax can be a bit cryptic and takes some getting used to
